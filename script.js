...
function initPageTransitions() {
    ...
    if (!document.querySelector(".page-transition")) {
        ...
        overlay.style.background = "radial-gradient(circle, rgba(26, 39, 179, 0.1) 0%, rgba(0, 0, 0, 0.7) 100%)";
        ...
        colorLayer.style.background = "linear-gradient(135deg, rgba(26, 39, 179, 0.05), rgba(108, 19, 163, 0.05))";
    ...
    internalLinks.forEach((link) => {
        ...
        const handleNavigation = function (e) {
            ...
            const reducedEffects = window.reducedEffects === true || document.body.classList.contains("reduced-effects");
            ...
            if (reducedEffects) {
                ...
                document.body.style.filter = isMobile ? "brightness(0.9)" : "brightness(0.85)";
            }
